...
//	}
	...
	public void user_is_loggedin_to_the_actitime_application_using_and(String un, String pwd)
	...
	public void create_customer_page_is_displayed() {
		Assert.assertEquals(driver.findElement(By.id("customerLightBox_titlePlaceholder")).getText(),
				"Create New Customer");
...
//		driver.close();
	...
	public void user_enters_customername_and_customerdescription_repeatedly_to_create_mulitple_customer(
	...
	public void user_enters_customername_and_customerdescription_repeatedly_as_list_to_create_mulitple_customer(
			DataTable dataTable) throws InterruptedException {
	...
	public void user_enters_customername_and_customerdescription_as_mapdata(DataTable dataTable)
			throws InterruptedException {
	...
	public void user_enters_customername_and_customerdescription_as_listdata(DataTable dataTable)
			throws InterruptedException {
	...
	public void customer_with_usersearch_should_be_displayed(String cn) {
		...
		int serachCount = driver
				.findElements(By
						.xpath("//div[@class='itemsContainer']//div[@class='title' and contains(text(),'" + cn + "')]"))
				.size();
	...
	public void user_moves_the_mouse_on_the_gear_icon_next_to_and_click_on_it(String string) {
		...
		act.moveToElement(driver.findElement(
				By.xpath("//div[@class='itemsContainer']//div[@class='title' and contains(text(),'" + string + "')]")))
				.perform();

		act.click(driver.findElement(By.xpath("//div[@class='itemsContainer']//div[@class='title' and contains(text(),'"
				+ string + "')]/following-sibling::div"))).perform();
